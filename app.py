...
.stApp{background:linear-gradient(160deg,#f4f8fa,#e9f1f4 55%,#f8f6f0);color:#000}
h1,h2,h3{font-family:Manrope,sans-serif!important;color:#000!important}
.block-container{max-width:1100px;padding-top:2.4rem;padding-bottom:3rem}
.hero{border-radius:26px;min-height:280px;padding:34px 40px;color:#000;display:flex;flex-direction:column;justify-content:space-between;background:linear-gradient(90deg,rgba(255,255,255,.78),rgba(255,255,255,.15)),var(--scene);background-size:cover;background-position:center;box-shadow:0 18px 48px #1d526324}
.hero .eyebrow{font-size:12px;letter-spacing:.17em;text-transform:uppercase;font-weight:700}.hero h1{color:#000!important;font-size:clamp(38px,6vw,64px)!important;margin:12px 0 3px}.hero p{color:#000;font-size:17px;margin:0}
...
div[data-testid="stMetricLabel"],div[data-testid="stMetricLabel"] p{color:#000!important;opacity:1!important;font-weight:700!important}
div[data-testid="stMetricValue"],div[data-testid="stMetricValue"] div{color:#000!important;opacity:1!important}
body,body *{color:#000!important;opacity:1!important}div[data-testid="stPlotlyChart"] svg text{fill:#000!important}
...
st.title("Værglimt")
st.caption("Et lite skoleprosjekt om været i Hamar")
try:
...
fig.update_layout(height=360,margin={"l":12,"r":12,"t":20,"b":8},paper_bgcolor="rgba(255,255,255,.68)",plot_bgcolor="rgba(255,255,255,.25)",font={"family":"DM Sans, sans-serif","color":"#000"},xaxis={"title":None,"showgrid":False,"tickformat":"%H:%M","linecolor":"#c7d8dc"},yaxis={"title":"Temperatur (°C)","gridcolor":"#dce7e8","zerolinecolor":"#b7c9cc"},hovermode="x unified")
